      ...
      <div className="container-prose">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-cream/10">
          <div className="lg:col-span-2">
            <div className="mb-6 flex items-center relative w-48 sm:w-56 h-16 sm:h-20 shrink-0">
              <img src="/thiru_annamalai_logo.svg" alt="Thiru Annamalai Natural Foods" className="absolute -left-4 sm:-left-6 top-1/2 -translate-y-1/2 w-[200px] sm:w-[240px] max-w-none object-contain pointer-events-none" />
            </div>
