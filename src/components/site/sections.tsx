      ...
      <div className="container-prose">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-cream/10">
          <div className="lg:col-span-2">
            <div className="mb-6 flex items-center justify-center bg-white/95 rounded-2xl shadow-soft w-[220px] h-[80px] overflow-hidden relative">
              <img src="/thiru_annamalai_logo.svg" alt="Thiru Annamalai Natural Foods" className="absolute w-[340px] max-w-none h-auto object-contain" />
            </div>
